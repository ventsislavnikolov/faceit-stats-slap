-- ============================================================
-- Fix: One-sided pool winners get 2x payout (equivalent to 1:1 odds)
-- instead of just getting their bet back (NET=0).
-- ============================================================
...
BEGIN
  ...
  -- One-sided pool: winners get 2x (1:1 odds), losers lose coins
